...
public class BadRequestErrorCreator {
    ...
    private static @NonNull List<@NonNull InvalidParam> createInvalidParamList(ConstraintViolationException ex) {
    ...
    private static @NonNull InvalidParam createInvalidParam(ConstraintViolation<?> violation) {
